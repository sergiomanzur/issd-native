...
/* Split translation unit: bank $0B, part 0E; entry PCs $F000-$F7FF. */

RecompReturn bank_0B_F422_M0X0(CpuState *cpu);

RecompReturn bank_0B_F422_M0X0(CpuState *cpu) {
  extern const char *g_last_recomp_func;
  g_last_recomp_func = "bank_0B_F422_M0X0";
  RecompStackPush("bank_0B_F422_M0X0");
  cpu_dbg_funcname("bank_0B_F422_M0X0");
  cpu_trace_func_entry(cpu, 0x0BF422, "bank_0B_F422_M0X0");
  if (interp_bridge_lle_master_deadline_reached(cpu)) {
    RecompStackPop();
    return interp_bridge_lle_yield_unwind(cpu, 0x0BF422u);
  }
  ...
  L_F422_M0X0:
    ...
    RecompStackPop();
    return interp_tier_dispatch_tail(cpu, 0x0bf422u, 0x0bf422u, _entry_s, _hrv);
    RecompStackPop();
...
void bank_0B_F422(CpuState *cpu) {
  RecompReturn _r;
  switch (((cpu->m_flag & 1) << 1) | (cpu->x_flag & 1)) {
    case 0: _r = bank_0B_F422_M0X0(cpu); break;
    case 1: _r = interp_tier_dispatch(cpu, 0x0bf422u); break; /* exact M0X1 LLE */
    case 2: _r = interp_tier_dispatch(cpu, 0x0bf422u); break; /* exact M1X0 LLE */
    case 3: _r = interp_tier_dispatch(cpu, 0x0bf422u); break; /* exact M1X1 LLE */
    default: _r = interp_tier_dispatch(cpu, 0x0bf422u); break;
  }
